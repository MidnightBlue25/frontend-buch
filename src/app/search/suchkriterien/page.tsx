...
export default function SuchkriterienPage() {
  ...
  const [gefilterteBuecher, setGefilterteBuecher] = useState<Buch[] | null>(
    null,
  ...
  const toggleSchlagwort = (wert: string) => {
    setSchlagwoerter((prev) =>
      prev.includes(wert) ? prev.filter((w) => w !== wert) : [...prev, wert],
    );
  };
          ...
          <ListGroup variant="flush">
            {gefilterteBuecher.map((buch, index) => (
              <ListGroup.Item key={index}>
                <strong>ISBN:</strong> {buch.isbn}| <strong>Titel:</strong>{' '}
                {buch.titel.titel}| <strong>Art:</strong> {buch.art}|{' '}
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)} centered>
        ...
        <Modal.Body>
          {selectedBuch && (
            <>
              <p>
                <strong>ID:</strong> {selectedBuch.id}
              </p>
              <p>
                <strong>Version:</strong> {selectedBuch.version}
              </p>
              <p>
                <strong>Titel:</strong> {selectedBuch.titel.titel}
              </p>
              <p>
                <strong>Untertitel:</strong> {selectedBuch.titel.untertitel}
              </p>
              <p>
                <strong>ISBN:</strong> {selectedBuch.isbn}
              </p>
              <p>
                <strong>Rating:</strong> {selectedBuch.rating}
              </p>
              <p>
                <strong>Art:</strong> {selectedBuch.art}
              </p>
              <p>
                <strong>Preis:</strong> {selectedBuch.preis} €
              </p>
              <p>
                <strong>Rabatt:</strong> {selectedBuch.rabatt || '–'}
              </p>
              <p>
                <strong>Lieferbar:</strong>{' '}
                {selectedBuch.lieferbar ? 'Ja' : 'Nein'}
              </p>
              <p>
                <strong>Datum:</strong> {selectedBuch.datum}
              </p>
              <p>
                <strong>Homepage:</strong> {selectedBuch.homepage || '–'}
              </p>
              <p>
